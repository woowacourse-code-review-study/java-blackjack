...
``` 
넵넵! 그렇다면 결국 딜러와의 비교 를 통해서 결과를 알아낼 수 있는 것 같아요.
그런 의미에서 블랙잭이나 승 / 패 / 비김 등에 대해서는 WinningStatus에서 관리하는 건 어떨까요?
일부상황에서 확인 할 수 있다고 해서 해당 역할을 BlackJackStatus 로 주게 되면 역할의 경계가 모호해지는 것 같아요.
```
